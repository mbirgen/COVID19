...
if(as.character(hospital[nrow(hospital),1])!= date){
...
clean <- clean %>% mutate(wktot = positive - lag(positive, n=7))
...
Today we had 821 new positive tests which is 13.5% (15.7% in the last week) of the tests in the last 24 hours. There are 20,098 people actively sick and 1.5% (309) are hospitalized. 29.4% (91) of those hospitalized are in the ICU and 9 new deaths.
