...
sick <- format(today$Still.Sick, scientific = FALSE)
IowaPop <- 3155070
...
####### The next part turns the pdf into a data table
...
pBremer
```
There are `r clean$Bremer.SS[nrow(clean)]` active cases and `r hosp_by_county["Bremer",][[2]]` hospitalized in Bremer County today.

`r hosp_by_county[c("Bremer", "Butler", "Black Hawk"),][2]`
