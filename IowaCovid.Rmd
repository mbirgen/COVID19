...
One year ago, we had `r format(covid19[oneyearago,]$Still.Sick, scientific = FALSE, big.mark=",")` actively sick and `r format(covid19[oneyearago,]$New.Positive, scientific = FALSE, big.mark=",")` new positive patients per day in Iowa. 

Two years ago, we had `r format(covid19[twoyearago,]$Still.Sick, scientific = FALSE, big.mark=",")` actively sick and `r covid19[twoyearago,]$New.Positive` new positive patients per day in Iowa.
