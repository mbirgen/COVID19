...
Summary <- pdf_text(
    "access _ Iowa COVID-19 Information11.pdf") %>%
    readr::read_lines() %>% str_squish()
...
qplot(date, hospitalized, data = tail(covid19, n=40))+geom_smooth(span = 0.3, se = TRUE) 
```
