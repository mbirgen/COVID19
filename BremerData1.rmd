...
In the last 7 days: `r New.Positive.Tests[nrow(New.Positive.Tests),"Bremer"]` new positive tests, `r as.integer(Bremerlastrow$New.Pos)`  new positive cases`r if(Brtemp$New.Pos) {" (record)"}`, `r as.integer(Bremerlastrow["New.Deaths"])` new death(s) and `r New.Tests[nrow(New.Tests),"Bremer"]`  total tests for a test positivity rate of `r round(New.Positive.Tests[nrow(New.Positive.Tests),"Bremer"]/New.Tests[nrow(New.Tests),"Bremer"]*100, digits = 2)` percent.
...
In the last 7 days: `r New.Positive.Tests[nrow(New.Positive.Tests),"Butler"]` new positive tests, `r as.integer(Butlerlastrow["New.Pos"])` new positive cases, `r as.integer(Butlerlastrow["New.Deaths"])` new death(s) and `r New.Tests[nrow(New.Tests),"Butler"]` total tests for a test positivity rate of `r round(New.Positive.Tests[nrow(New.Positive.Tests),"Butler"]/New.Tests[nrow(New.Tests),"Butler"]*100, digits = 2)` percent.
...
In the last 7 days: `r New.Positive.Tests[nrow(New.Positive.Tests),"Black.Hawk"]` new positive tests, `r as.integer(Black.Hawklastrow["New.Pos"])` new positive cases`r if(BHtemp$New.Pos) {" (record)"}`, `r as.integer(Black.Hawklastrow["New.Deaths"])` new death(s) and and `r New.Tests[nrow(New.Tests),"Black.Hawk"]` total tests for a test positivity rate of `r round(New.Positive.Tests[nrow(New.Positive.Tests),"Black.Hawk"]/New.Tests[nrow(New.Tests),"Black.Hawk"]*100, digits = 2)` percent.
