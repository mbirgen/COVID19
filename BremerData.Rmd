...
In the last 24 hours: `r as.integer(Bremerlastrow$New.Pos)` new positive cases`r if(temp$New.Pos) {" (record)"}`, `r as.integer(Bremerlastrow["New.Deaths"])` new death(s) and `r as.integer(Bremerlastrow$New.Test)` new people tested.
